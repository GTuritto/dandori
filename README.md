...
Read the [Executive Summary](docs/executive-summary.md) for a two-minute overview, then explore the three parts:

1. **[Part I: Why Dandori](docs/part-1-why/)** -- The case for a new framework
2. **[Part II: What Is Dandori](docs/part-2-what/)** -- The framework defined
3. **[Part III: How Dandori Works](docs/part-3-how/)** -- Implementation and practice
